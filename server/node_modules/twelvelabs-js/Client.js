...
const Client_6 = require("./api/resources/manageEntities/client/Client");
const Client_7 = require("./api/resources/embed/client/Client");
...
class TwelvelabsApiClient {
    ...
    get embed() {
        var _a;
        return ((_a = this._embed) !== null && _a !== void 0 ? _a : (this._embed = new Client_7.Embed(this._options)));
    }
    get search() {
        var _a;
