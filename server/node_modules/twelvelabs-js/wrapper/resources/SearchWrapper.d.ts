...
export declare class SearchWrapper extends Search {
     ...
     *     })
     */
    query(request: TwelvelabsApi.SearchCreateRequest, requestOptions?: Search.RequestOptions): Promise<core.Page<TwelvelabsApi.SearchItem>>;
}
